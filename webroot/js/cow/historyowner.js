...
//headerRow.push('ห้องประชุม');
    ...
    headerRow.push({text: 'ชื่อ-สกุล', style: 'tableHeader', /*rowSpan: 2,*/ alignment: 'center', fontSize: 12, bold: true});
    headerRow.push({text: 'หมายเลขประจำตัวประชาชน', style: 'tableHeader', /*rowSpan: 2,*/ alignment: 'center', fontSize: 12, bold: true});
    headerRow.push({text: 'ที่อยู่ฟาร์ม', style: 'tableHeader', /*rowSpan: 2,*/ alignment: 'center', fontSize: 12, bold: true});
    headerRow.push({text: 'เบอร์โทร', style: 'tableHeader', /*rowSpan: 2,*/ alignment: 'center', fontSize: 12, bold: true});
    headerRow.push({text: 'วันที่เป็นเจ้าของ', style: 'tableHeader', /*rowSpan: 2,*/ alignment: 'center', fontSize: 12, bold: true});
...
//return ;
    ...
    var dd = {
        content: [ 
            {text: 'ประวัติการเป็นเจ้าของโค รหัสโค :  ', style: 'header', alignment: 'center', margin: [0, 10, 0, 0]},
            {
                table: {
                    headerRows: 1,
...
//            }
    ...
    pdfMake.createPdf(dd).download('ประวัติการเป็นเจ้าของโค.pdf');
}